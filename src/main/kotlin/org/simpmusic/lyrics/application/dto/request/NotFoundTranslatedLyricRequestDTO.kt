...
/**
 * Request Data Transfer Object for Not Found Translated Lyrics
 * Used for POST/PUT operations where client doesn't provide an ID
 */
data class NotFoundTranslatedLyricRequestDTO(
    val videoId: String,
    val translationLanguage: String,
    val addedDate: LocalDateTime = LocalDateTime.now(),
) : BaseRequestDTO {
    @JsonIgnore
    override fun getUniqueId(): String = (videoId + translationLanguage).sha256()
} 