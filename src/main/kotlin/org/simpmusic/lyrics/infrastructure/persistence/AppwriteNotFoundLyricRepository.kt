...
class AppwriteNotFoundLyricRepository(
    ...
    override fun findById(id: String): Flow<Resource<NotFoundLyric?>> =
        flow {
    ...
    override fun findByVideoId(videoId: String): Flow<Resource<NotFoundLyric?>> =
        flow {
    ...
    override fun findAllOrderedByDate(
        limit: Int?,
        offset: Int?,
    ): Flow<Resource<List<NotFoundLyric>>> =
        flow {
    ...
    override fun save(notFoundLyric: NotFoundLyric): Flow<Resource<NotFoundLyric>> =
        flow {
    ...
    override fun deleteByVideoId(videoId: String): Flow<Resource<Boolean>> =
        flow {
